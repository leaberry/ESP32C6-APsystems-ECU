...
.section{margin-top:22px}.form-card{max-width:760px;background:var(--panel);border:1px solid var(--line);border-radius:14px;padding:22px}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.field{display:flex;flex-direction:column;gap:6px}.field.full{grid-column:1/-1}label{font-weight:700}input,select{width:100%;min-height:42px;border:1px solid var(--line);border-radius:8px;background:#0c1627;color:var(--text);padding:8px 10px;font:inherit}input[type=checkbox]{width:20px;min-height:20px;accent-color:var(--accent)}.checkline{display:flex;gap:10px;align-items:flex-start}.checkline label{font-weight:600}.help{font-size:.85rem}.actions{display:flex;gap:10px;margin-top:22px;flex-wrap:wrap}.alert{padding:12px 14px;border-left:4px solid var(--warn);background:#342b19;border-radius:8px;color:#ffe39a}.alert.info{border-color:var(--accent2);background:#122c38;color:#b9eef8}.night-status{font-size:1rem;font-weight:750;margin:12px 0 0}.title-edit{display:flex;align-items:center;gap:10px}.title-edit h1{margin-bottom:8px}.edit-icon{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border:1px solid var(--line);border-radius:8px;background:var(--panel2);color:var(--text);text-decoration:none;font-size:1.15rem}.edit-icon:hover{border-color:var(--accent2)}.table-wrap{overflow:auto;border:1px solid var(--line);border-radius:12px}.data-table{width:100%;border-collapse:collapse;background:var(--panel)}.data-table th,.data-table td{padding:10px 12px;border-bottom:1px solid var(--line);text-align:left;white-space:nowrap}.data-table th{color:var(--muted);font-size:.8rem;text-transform:uppercase;letter-spacing:.05em}.energy-chart{display:grid;grid-template-columns:72px minmax(0,1fr);gap:8px}.y-axis{height:210px;padding:10px 0 28px;display:flex;flex-direction:column;justify-content:space-between;text-align:right;color:var(--muted);font-size:.72rem;font-variant-numeric:tabular-nums}.bars{height:210px;display:flex;align-items:flex-end;gap:3px;padding:12px 5px 28px;border-left:1px solid var(--line);border-bottom:1px solid var(--line);background:linear-gradient(to bottom,transparent 0,transparent calc(50% - 1px),var(--line) 50%,transparent calc(50% + 1px),transparent 100%)}.bar{position:relative;flex:1;min-width:5px;background:linear-gradient(var(--accent2),#197a91);border-radius:4px 4px 0 0}.bar span{position:absolute;bottom:-23px;left:50%;transform:translateX(-50%);font-size:.66rem;color:var(--muted)}.empty{padding:28px;text-align:center;color:var(--muted)}
...
@media(max-width:700px){.metrics,.form-grid{grid-template-columns:1fr}.field.full{grid-column:auto}.page{width:min(100% - 20px,1120px);padding-top:15px}.hero{padding:20px}.topbar{position:static}.metric,.card{padding:15px}.data-table th,.data-table td{padding:8px}.energy-chart{grid-template-columns:58px minmax(320px,1fr);overflow-x:auto}.hide-mobile{display:none}}
)=====";

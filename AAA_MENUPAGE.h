...
<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>APsystems ECU menu</title><link rel="icon" href="/favicon.ico"><link rel="stylesheet" type="text/css" href="/stylesheet?v=1.4.15"></head>
...
<div class="menu-item"><a href="/system"><strong>System information</strong></a><span>Firmware, memory, radio, network and polling status</span><p>ECU_ID: <a href="/basicconfig#ecuid">{ecuid}</a></p></div>
...
<a class="menu-item" href="/mqtt"><strong>MQTT</strong><span>Shared broker, Home Assistant and Domoticz configuration</span></a>

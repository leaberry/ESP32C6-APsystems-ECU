...
6. **MQTT end to end:** basic HA MQTT now has reporter confirmation. Broker
   persistence/restart recovery, Energy statistics, physical limit commands and
   simultaneous HA/Domoticz load still need explicit field validation.

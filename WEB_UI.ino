...
String ecuPageStart(const String &title, const String &description) {
  ...
  page += F(" · APsystems ECU</title><link rel=\"icon\" href=\"/favicon.ico\"><link rel=\"stylesheet\" type=\"text/css\" href=\"/stylesheet?v=1.4.11\"></head><body><header class=\"topbar\"><a class=\"brand\" href=\"/\">ESP32-C6 ECU</a><nav class=\"nav\"><a class=\"button secondary\" href=\"/menu\">Menu</a></nav></header><main class=\"page\"><div class=\"eyebrow\">ESP32-C6 controller</div><h1>");
  page += webEscape(title);
  page += F("</h1><p>");
